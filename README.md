...
<h3 align="center">Welcome to my profile! 👋 As a junior web developer with a passion for crafting exceptional web applications, I specialize in full-stack development, excelling in both front-end and back-end technologies. With expertise in HTML, CSS, JavaScript, React, Node.js, Express.js, MongoDB and more, and I leverage my solid background in these technologies to adapt seamlessly to project requirements. Eager to contribute to innovative projects, I'm committed to continuous learning and growth in the dynamic field of web development. </h3>
